      ...
      <header className="mx-auto mb-5 flex max-w-6xl items-center justify-between border-b border-[#575244] pb-4">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.28em] text-[#625e52]">Pre-registration for 15/08/2026</p>
          </div>
        </div>
        <Link href="/" className="key-shadow text-[9px] sm:text-[10px] font-bold uppercase tracking-[.12em] underline text-[#625e52] whitespace-nowrap"><ArrowLeft size={13} className="inline" /> Fax</Link>
      </header>
        ...
        <SkinPanel theme={theme} className="machine-shadow overflow-hidden rounded-[18px] border border-[#8f8878] bg-[#c8c0ae]">
          ...
          <div className="p-5 md:p-8 space-y-4">
            <div className="border-2 border-[#e65b2f] bg-[#f5dcc8] p-3 text-center">
              <p className="text-[10px] font-black uppercase tracking-[.14em] text-[#8a3e1e]">⚡ Launch promotion — first 100 entries get 5 fax credits</p>
            </div>
            ...
            <label className="block">
              ...
              <span className="mt-1 block text-[8px] font-bold uppercase tracking-[.14em] text-[#847d6e]">Just add your {theme.collectionName} token ID</span>
            </label>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {!isOwn && (
                        <Link
                          ...
                          className="key-shadow flex items-center gap-1 border border-[#77705f] bg-[#d8d0bf] px-2 py-1 text-[8px] font-bold uppercase hover:bg-[#e65b2f] hover:text-white hover:border-[#983b21] transition-colors"
                      ...
                      {isOwn && (
                        <span className="text-[8px] font-bold uppercase text-[#847d6e]">You</span>
                      )}
                      {isOwn && (
                        <button
