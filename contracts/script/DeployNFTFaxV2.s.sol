...
/// @notice Deploys NFTFaxCollectibleV2 to Base mainnet with production config.
/// @dev Run with:
///   forge script script/DeployNFTFaxV2.s.sol:DeployNFTFaxV2 \
...
contract DeployNFTFaxV2 is Script {
    ...
    function run() public {
        ...
        NFTFaxCollectibleV2 fax = new NFTFaxCollectibleV2(
            "NFTFax Collectible",
            "FAX",
            mintPrice,
            deployer
        ...
        console.log("NFTFaxCollectibleV2 deployed at:", address(fax));
